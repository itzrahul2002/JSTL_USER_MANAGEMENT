...
<body>
    ...
    <main style="width: 80%; height: 70%">
        ...
        <div class="headline">
            <h2 class="text-headline">Register Student</h2>
            <h3 class="text-subheadline">The Student portal 🧑‍💻</h3>
        </div>
        <form action="Std_Register-servlet" method="post">
            <span>
            ...
            <input class="text-small-uppercase" id="submit" type="submit" value="Register">
        </form>
    </main>
    ...
    <script>
        ...
        function onSubmit( ev ) {
            ...
            console.log(status);
            if(status == "success"){
                swal("Congrats","Student Data Inserted Successfully ","success");
            }
            if(status == "failure"){
                swal("Sorry","Student Data Insert Failed ","failure");
            }
